...
---
What's here
Two AI maths-tutoring platforms, both built and owned solo. Different problems, shared engineering principles.
	X1	aitutormaths
...
Teacher view — KP mastery across 86 topics, 276 KPs
...
AI / LLM: Claude API (Opus, Sonnet) · OpenAI API (Whisper STT, TTS, GPT) · Claude Vision · prompt & agent design · multi-model QA workflows · exploring Claude orchestration via MCP
